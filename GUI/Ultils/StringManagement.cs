...
namespace GUI.Ultils
{
    public class StringManagement
    {
        ...
        public static string InitializePlayerTurn()
        {
            CharacterDTO characterDTO = (CharacterDTO)Program.Dic_Bundles[StringManagement.KeyDatas.CharacterDTO_Key];
            return characterDTO.username;
        }

        public static string InitializePlayerTurn2()
        {
            CharacterDTO characterDTO = (CharacterDTO)Program.Dic_Bundles[StringManagement.KeyDatas.CharacterDTO_Key2];
            return characterDTO.username;
        }

        public static string Vesus()
        {
            CharacterDTO characterDTO = (CharacterDTO)Program.Dic_Bundles[StringManagement.KeyDatas.CharacterDTO_Key];
            return characterDTO.username;
        }

        public static string Vesus2()
        {
            CharacterDTO characterDTO2 = (CharacterDTO)Program.Dic_Bundles[StringManagement.KeyDatas.CharacterDTO_Key2];
            return characterDTO2.username;
        }
        ...
        public class KeyDatas
        {
            ...
            public static string CharacterDTO_Key2 = "CharacterDTO2";
            public static string CharacterBLL_Key = "CharacterBLL";
            public static string CharacterBLL_Key2 = "CharacterBLL2";
            public static string PlayerAvatar_Key = "PlayerAvatar";
            public static string PlayerAvatar_Key2 = "PlayerAvatar2";
